...
public partial class UserDefinedFunctions
{
    ...
    public static SqlXml ReadPubmedAPI (string requestMethod, string url, string parameters, string headers, int timeout, bool autoDecompress, bool convertResponseToBas64 , string autval)
    {
        ...
        if (autval.Length > 1)
        {
            request.Headers.Add("Authorization", autval);
        }
